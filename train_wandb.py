...
def main_worker():
    ...
    if args.load == '':
        ...
        wbrun = wandb.init(project=args.experiment, config=vars(args))
        ...
        wbrun = wandb.init(project=args.experiment, id=checkpoint['wbid'], resume='must')
    ...
    for epoch in range(args.start_epoch, args.total_epochs):
        ...
        wbrun.log({'Learning_rate': optimizer.param_groups[0]['lr'], 
                   'Training_loss': average_loss, 
                   'Training_loss_coord': average_loss_coord, 
